...
{{- $result := include "mandatoryArgumentsCheck" .Values.service.nonSecure.containerPort -}}
{{- if eq $result "false" -}}
{{- fail "Configuration Missing: Please provide valid value for .Values.service.nonSecure.containerPort" -}}
{{- end -}}

{{- $result := include "mandatoryArgumentsCheck" .Values.service.secure.containerPort -}}
{{- if eq $result "false" -}}
{{- fail "Configuration Missing: Please provide valid value for .Values.service.secure.containerPort" -}}
{{- end -}}
