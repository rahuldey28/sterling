...
*/
{{- define "ibm-seas.nodeAffinity" }}
{{- $rootCtx := index . 0 }}
{{- $currNodeAffinity := index . 1 }}
{{- $archRequiredMatchExpressions := include "ibm-seas.nodeAffinityArchRequired.matchExpressions" $rootCtx }}
nodeAffinity:
...
*/
{{- define "ibm-seas.nodeAffinityArchRequired.matchExpressions" }}
...
/*
  Pod Anti Affinity
*/
{{- define "ibm-seas.podAntiAffinity" }}
{{- $rootCtx := index . 0 }}
