...
if supports_scc; then
    ...
    kubectl delete -f ../../pre-install/clusterAdministration/ibm-seas-scc.yaml
	echo "Deleting ClusterRole"
    kubectl delete -f ../../pre-install/clusterAdministration/ibm-seas-cr-scc.yaml
	isApplied="true"
fi
...
if supports_psp; then
    if [ "$isApplied" == "false" ]; then
		...
		kubectl delete -f ../../pre-install/clusterAdministration/ibm-seas-psp.yaml
		echo "Deleting ClusterRole"
		kubectl delete -f ../../pre-install/clusterAdministration/ibm-seas-cr.yaml
	fi
fi
